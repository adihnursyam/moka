...
export async function generateMetadata({ params }: Readonly<{ params: Promise<{ category: string }> }>) {
  ...
  return {
    title: `Profil Semifinalis - ${category.name} 2025`,
    description: `Profil Semifinalis Pasanggiri Mojang Jajaka Kabupaten Garut 2025 pada kategori ${category.name}.`,
  };
}
  ...
  return (
    <main className="min-h-screen overflow-hidden relative">
      ...
      <div className="w-full h-[75lvh] bg-center bg-cover bg-no-repeat bg-[url(/dewasa.webp)] relative flex justify-center flex-col text-white md:px-20 px-8 shadow-[inset_0_0_0_50vw_rgba(0,0,0,0.5)] text-sm">
        <typography.h1 className='capitalize max-w-xl text-3xl md:text-5xl'>Profil Semifinalis {category?.name} 2025</typography.h1>
